...
<nav class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <li><a href="public/create_invoice.php"><i class="bi bi-receipt"></i> Sales Invoice</a></li>
        <li><a href="public/create_purchase.php"><i class="bi bi-cart-plus"></i> Purchase Entry</a></li>
        <li><a href="public/proforma_invoice.php"><i class="bi bi-file-earmark-text"></i> Proforma Invoice</a></li>
        <li><a href="public/quotation.php"><i class="bi bi-file-earmark-ruled"></i> Quotation</a></li>

        <li class="nav-header">Records</li>
        <li><a href="public/view_invoices.php"><i class="bi bi-graph-up-arrow"></i> Sales Invoices</a></li>
        <li><a href="public/view_purchases.php"><i class="bi bi-cart-check"></i> Purchase Invoices</a></li>
        <li><a href="src/view.php"><i class="bi bi-journal-text"></i> Sales Records</a></li>
        <li><a href="public/view1.php"><i class="bi bi-journal-arrow-down"></i> Purchase Records</a></li>
        ...
        <li><a href="public/add_tool.php"><i class="bi bi-tools"></i> Tools</a></li>
    </ul>
</nav>
