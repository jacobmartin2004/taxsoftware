...
if ($has_items_table && count($records) > 0) {
    $bill_nums = array_map(function ($r) {
        return intval($r['bill']);
    }, $records);
...
<head>
    ...
    <style>
        ...
        .items-tbl th.text-center {
            text-align: center;
        }

        .items-tbl th:last-child {
            text-align: right;
        }
        ...
        .items-tbl td.text-center {
            text-align: center;
        }

        .items-tbl td:last-child {
            text-align: right;
        }
    ...
    <div class="page-wrap">
        ...
        foreach ($records as $r) {
            ...
            $pdf_records[] = [
                ...
                'cname' => $r['cname'],
                'GSTNO' => $r['GSTNO'],
                'taxamt' => floatval($r['taxamt']),
                'cgst' => floatval($r['cgst']),
                'sgst' => floatval($r['sgst']),
                'igst' => floatval($r['igst']),
        ...
        <script>
            ...
            function buildInvoiceHTML(r) {
                ...
                var cgst_label = 'CGST (9%)',
                    sgst_label = 'SGST (9%)';
                if (r.gsttype === '25P') {
                    cgst_label = 'CGST (12.5%)';
                    sgst_label = 'SGST (12.5%)';
                } else if (r.gsttype === '6P') {
                    cgst_label = 'CGST (3%)';
                    sgst_label = 'SGST (3%)';
                }
