...
<head>
  <meta charset="UTF-8">
  <title>Sales Report - <?php echo $month_name . ' ' . $sel_year; ?></title>
  <style>
...
<div class="print-header">
    ...
    <h4>SALES REPORT - <?php echo strtoupper($month_name) . ' ' . $sel_year; ?></h4>
</div>
...
<?php else: ?>
<p style="text-align:center; padding:30px; color:#888;">No sales records for <?php echo $month_name . ' ' . $sel_year; ?></p>
<?php endif; ?>
...
<div class="action-bar">
    ...
    <a class="btn-back" href="view.php?month=<?php echo $sel_month; ?>&year=<?php echo $sel_year; ?>">Back to Sales</a>
</div>
...
function applyFilter() {
    ...
    window.location.href = 'printsales.php?month=' + m + '&year=' + y;
}
</script>
</body>
</html>